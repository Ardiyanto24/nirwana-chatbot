...
Keputusan 8, dipertahankan M7.7 Keputusan 7): hanya kejadian yang TIDAK
butuh LLM/DB/Jaeger nyata (short-circuit deterministik + wiring identity
mocked + kegagalan teknis salah satu cabang paralel). Kejadian yang
butuh eksekusi nyata (LLM/DB sungguhan, bukti span) ada di
evals/7.6-.../ dan evals/7.7-.../ - lihat rancangan.md/audit.md di
